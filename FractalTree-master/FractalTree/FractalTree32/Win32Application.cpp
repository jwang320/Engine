...
const BYTE keyvalues[256] = {0, DIK_A, DIK_B, DIK_C, DIK_D, DIK_E, DIK_F, DIK_G, DIK_H, DIK_I, DIK_J, DIK_K, DIK_L, DIK_M, DIK_N, DIK_O, DIK_P, DIK_Q, DIK_R, DIK_S, DIK_T, DIK_U, DIK_V, DIK_W, DIK_X, DIK_Y, DIK_Z, DIK_SPACE, DIK_ESCAPE, DIK_RETURN, DIK_DOWN, DIK_UP, DIK_LEFT, DIK_RIGHT, DIK_TAB, DIK_BACKSPACE, DIK_1, DIK_2, DIK_3, DIK_4, DIK_5, DIK_6, DIK_7, DIK_8, DIK_9, DIK_0, DIK_PERIOD, DIK_MINUS};
const BYTE asciivalues[256] = {0, 65, 66, 67, 68, 69, 70, 71, 72, 73, 74, 75, 76, 77, 78, 79, 80, 81, 82, 83, 84, 85, 86, 87, 88, 89, 90, 32, 27, 13, 0, 0, 0, 0, 9, 8, 49, 50, 51, 52, 53, 54, 55, 56, 57, 48, 46, 45};

bool keydown[256];
bool mousedown[4] = {false, false, false, false};
static FractalTreeApplication application;
...
const long long frameInterval = 8;
extern bool running;
extern volatile bool finishedRendering;
...
int WINAPI WinMain(HINSTANCE hInst, HINSTANCE, LPSTR strCmdLine, int)
{
	...
	FractalTreeResources::LoadOtherResources();
	hInstance = hInst;
#ifndef _DEBUG
	RECT desktop;
	...
	windowWidth = 1920; winWidth;
	windowHeight = 1080; winHeight;
	CreateMainWindow(false, windowWidth, windowHeight);
#else
	...
	//program now initialized from spacebar. nevermind now it's not.
	InitializeApplication();
	InitDInput();

	//shouldn't return from this for a very long time.
	Run();
