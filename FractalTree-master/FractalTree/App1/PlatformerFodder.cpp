...
PlatformerFodder::PlatformerFodder(BlockUniverse* parentBlockUniverse, int owningCharacter, int owningPlayer, const ObjectParameters& objectParameters, const MoveableParameters& moveableParameters, PlatformerCharacter* player) :
	...
	playerID(player->GetGlobalID())
{
	...
	this->loadBlockModel("PixelFodder.m");
}
