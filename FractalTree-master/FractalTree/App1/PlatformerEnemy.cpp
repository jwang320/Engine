...
PlatformerEnemy::PlatformerEnemy(BlockUniverse* parentBlockUniverse, int owningCharacter, int owningPlayer, const ObjectParameters& objectParameters, const MoveableParameters& moveableParameters, PlatformerCharacter* player) :
	...
	coolDown(0)
{
	...
	this->loadBlockModel("EvilPixelRobot.m");
}