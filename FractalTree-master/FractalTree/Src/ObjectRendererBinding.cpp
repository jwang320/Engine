...
{
	template class ObjectRendererBindingGraph<PhysicalWorldSimulation, Actor::ObjectData, FractalTreeRenderer, LocalObjectData>;
	template class ObjectRendererBindingGraph<PhysicalWorldSimulation, Actor::ObjectData, StandardCubeRenderer, int>;
